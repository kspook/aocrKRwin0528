...
class Model(object):
    ...
    def predict(self, image_file_data):
        ...
        data_path=''  # blank path  
        self.data_path=data_path            
        s_gen = DataGen(data_path, self.buckets, self.phase, image_file_data, epochs=1, max_width=self.max_original_width)
        ...
        for batch in s_gen.gen(1):
            ...
            print ('text, probability, num_total,  ', text, probability, num_total)
    ...
    def train(self, data_path, num_epoch):
        ...
        image_file_data = b''        
        s_gen = DataGen(
            data_path, self.buckets, self.phase,image_file_data,
...
>>>>>>> 2ddf72ce0d692c33b3bd32ba730533daae784b99
